            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    var result = widget.dateRevisionModel!
                        .where((element) => element.delete == false);
      ...
      children: [
        Padding(
          ...
          child: DropdownButtonFormField<int>(
            ...
            onChanged: (int? value) {
              var result = widget.dateRevisionModel!
                  .where((element) => element.quantityDay == value);

              if (result.isEmpty) {
                widget.dateRevisionModel!
                    .add(DateRevisionModel(quantityDay: value));
              }
